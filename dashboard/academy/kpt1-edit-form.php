                        ...
                        <div class="card mb-5">
                            ...
                            <form method="post" action="kpt1-edit.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="kpt_1">Ketepatan Periode Training 1</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="kpt_1" name="kpt_1" type="text" placeholder="Ketepatan Periode Training 1" value="<?php echo $row['kpt_1']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group row">
