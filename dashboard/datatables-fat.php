                                            ...
                                            <tr>
                                                ...
                                                <?php if ($row['status_fat'] != "Approve"): ?>
                                                    ...
                                                    <form method="post" action="" class="status-form" style="display: none; margin-top: 10px;">
                                                        ...
                                                        <select class="form-control" name="status_fat" onchange="this.form.submit()">
                                                            <option value="In Process" <?= $row['status_fat'] == 'In Process' ? 'selected' : '' ?>>In Process</option>
                                                            <option value="Pending" <?= $row['status_fat'] == 'Pending' ? 'selected' : '' ?>>Pending</option>
                                                            <option value="Approve" <?= $row['status_fat'] == 'Approve' ? 'selected' : '' ?>>Approve</option>
                                                        </select>
                                                    </form>
                                                <?php endif; ?>
                                                </td>
