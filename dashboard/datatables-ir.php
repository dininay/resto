                                            ...
                                            <tr>
                                                ...
                                                <?php if ($row['status_ir'] != "Approve"): ?>
                                                    ...
                                                    <form method="post" action="" class="status-form" style="display: none; margin-top: 10px;">
                                                        ...
                                                        <select class="form-control" name="status_ir" onchange="this.form.submit()">
                                                            <option value="In Process" <?= $row['status_ir'] == 'In Process' ? 'selected' : '' ?>>In Process</option>
                                                            <option value="Pending" <?= $row['status_ir'] == 'Pending' ? 'selected' : '' ?>>Pending</option>
                                                            <option value="Approve" <?= $row['status_ir'] == 'Approve' ? 'selected' : '' ?>>Approve</option>
                                                        </select>
                                                    </form>
                                                <?php endif; ?>
                                                </td>
