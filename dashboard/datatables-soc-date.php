...
$sql = "SELECT l.kode_lahan, l.nama_lahan, l.lokasi, l.nama_lahan, l.status_land, r.id, d.kode_store
        FROM land l
        INNER JOIN resto r ON l.kode_lahan = r.kode_lahan
        INNER JOIN dokumen_loacd d ON r.kode_lahan = d.kode_lahan
                                    ...
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <!-- Tombol Edit -->
                                                        <div>
                                                            <a href="operation/soc-date-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                                            <i class="i-Pen-2"></i>
                                                            </a>
                                                            <a href="operation/soc-date-detail.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">
                                                            <i class="i-Book"></i>
                                                            </a>
                                                        </div>
                                                </td>
