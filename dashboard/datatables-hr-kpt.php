                                            ...
                                            <tr>
                                                ...
                                                <?php if ($row['status_kpt1'] != "Approve"): ?>
                                                    ...
                                                    <form method="post" action="" class="status-form" style="display: none; margin-top: 10px;">
                                                        ...
                                                        <select class="form-control" name="status_kpt1" onchange="this.form.submit()">
                                                            <option value="In Process" <?= $row['status_kpt1'] == 'In Process' ? 'selected' : '' ?>>In Process</option>
                                                            <option value="Pending" <?= $row['status_kpt1'] == 'Pending' ? 'selected' : '' ?>>Pending</option>
                                                            <option value="Approve" <?= $row['status_kpt1'] == 'Approve' ? 'selected' : '' ?>>Approve</option>
                                                        </select>
                                                    </form>
                                                <?php endif; ?>
                                                </td>
