                                            ...
                                            <tr>
                                                ...
                                                <?php if ($row['status_scm'] != "Approve"): ?>
                                                    ...
                                                    <form method="post" action="" class="status-form" style="display: none; margin-top: 10px;">
                                                        ...
                                                        <select class="form-control" name="status_scm" onchange="this.form.submit()">
                                                            <option value="In Process" <?= $row['status_scm'] == 'In Process' ? 'selected' : '' ?>>In Process</option>
                                                            <option value="Pending" <?= $row['status_scm'] == 'Pending' ? 'selected' : '' ?>>Pending</option>
                                                            <option value="Approve" <?= $row['status_scm'] == 'Approve' ? 'selected' : '' ?>>Approve</option>
                                                        </select>
                                                    </form>
                                                <?php endif; ?>
                                                </td>
